...
conclusion <- tabPanel(
  ...
  fluidPage(
    h1("Summary"),
 "Overall, more song lyrics have been censored over time. This observation prompts the question of whether song lyrics have gotten more explicit over time, or if uncensored lyrics from years past are being censored in current songs. The most censored category of words overall is “Profanity,” which includes many/mostly swear words.  This tells us that the parents of listeners along with those doing the censorship consider vulgar language inappropriate for kids to consume — as one may assume. We also see from the charts that “Identity” is the least censored category, and this includes words that describe gender and sexuality, such as “woman,” and “lesbian.” The reasoning behind this could be subjective, meaning some instances of “identity” lyrics are deemed appropriate on the basis of context, or, the “identity” category makes up the minority of songs/lyrics covered by Kidz Bop. The “Other” category also sees the least censorship, which includes religiously associated words and other words that are deemed to be inappropriate for children. Similar to lyrics under the “identity” category, this could be because the songs covered by Kidz Bop tend to lack lyrical content categorized as “other”. While there does appear to be some upward trends in censorship for categories like “alcohol & drugs” and “profanity”, this doesn’t necessarily imply that Kidz Bop has become stricter on how they’re policing these lyrics. Because Kidz Bop covers the most popular or highest charting songs of the year, these trends may better portray what “categories” of music are most successful among general society. From the line plot visualization, there is evidence indicating that Kidz Bop lyrics have been censored overtime, implying more taboo content in the music market." )
)
